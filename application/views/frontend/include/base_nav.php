<header id="header" id="home">
		    <div class="container">
		    	<div class="row align-items-center justify-content-between d-flex">
			      <div id="logo">
			        <a href="<?php echo base_url() ?>"><h3><b>WB TRANS TRAVEL</b></h3></a>
			      </div>
			      <nav id="nav-menu-container">
			        <ul class="nav-menu">
			          ...
			          <?php if ($this->session->userdata('username')) { ?>
				      	<li class="menu-has-children"><aWB href="">Hai, <?php echo $this->session->userdata('nama_lengkap'); ?></aWB TRANS TRAVEL
						<ul>
