			...
			<tr>
				<td colspan="2">
					<p style="text-align: justify; padding: 10px;">
						Dear Customer WB TRANS TRAVEL,<br>
						Terima kasih telah menggunakan WB TRANS TRAVEL.
					</p>
					<p style="text-align: justify; padding: 10px;">
						...
						<tr>
							...
							<tr>
								<td colspan="2">
									<p style="padding:10px;">
										<br>
										Hormat Kami,<br>
										<span style="color:#fd7521;"><strong>WB TRANS TRAVEL</strong></span>
										<br>
										<br>
									</p>
								</td>
							...
							<tr class="footer" style="font-size: 10px; background-color: #484B51;color:#ffffff;">
								<td style="padding-left:10px; padding-right:10px;">
									<?php echo date("Y"); ?> &copy; WB TRANS TRAVEL
								</td>
